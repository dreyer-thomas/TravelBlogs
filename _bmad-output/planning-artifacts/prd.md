...
- Viewers can discover trips by country via a Trips page world map that reflects only trips they’re allowed to view.
...
- Global Trips page world map for country-based navigation (scratch-map view)
...
### Trips Page World Map (Extension)
