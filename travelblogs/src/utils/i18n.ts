...
const translations = {
  en: {
    ...
    trips: {
      ...
      fileFormatHint: 'JPG, PNG, or WebP up to 15MB.',
      ...
      coverImageTypeError: 'Cover image must be a JPG, PNG, WebP, MP4, WebM, or MOV file.',
    ...
    entries: {
      ...
      mediaTypeError: 'Media files must be a JPG, PNG, WebP, MP4, WebM, or MOV file.',
  ...
  de: {
    ...
    trips: {
      ...
      fileFormatHint: 'JPG, PNG oder WebP bis zu 15 MB.',
      ...
      coverImageTypeError: 'Titelbild muss eine JPG-, PNG-, WebP-, MP4-, WebM- oder MOV-Datei sein.',
    ...
    entries: {
      ...
      mediaTypeError: 'Mediendateien müssen JPG-, PNG-, WebP-, MP4-, WebM- oder MOV-Dateien sein.',
