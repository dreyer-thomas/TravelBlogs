...
const translations = {
  en: {
    ...
    trips: {
      ...
      coverImageTypeError: 'Cover image must be a JPG, PNG, WebP, MP4, or WebM file.',
    ...
    entries: {
      ...
      mediaTypeError: 'Media files must be a JPG, PNG, WebP, MP4, or WebM file.',
  ...
  de: {
    ...
    trips: {
      ...
      coverImageTypeError: 'Titelbild muss eine JPG-, PNG-, WebP-, MP4- oder WebM-Datei sein.',
    ...
    entries: {
      ...
      mediaTypeError: 'Mediendateien müssen JPG-, PNG-, WebP-, MP4- oder WebM-Dateien sein.',
